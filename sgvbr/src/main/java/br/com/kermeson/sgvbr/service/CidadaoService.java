...
public interface CidadaoService {
	...
	/**
	 * Método que realiza a persistência da entidade Cidadao em banco de dados
	 *
	 * @param cidadao
	 *            - a instância da classe Cidadao que será persistida
	 * @return
	 */
	Cidadao incluir(Cidadao cidadao);
	...
	/**
	 * Método que realiza a alteração da entidade Cidadao
	 *
	 * @param cidadao
	 *            - a instância da classe Cidadao que será alterada
	 * @return o cidadão persistido
	 */
	Cidadao salvar(Cidadao cidadao);
